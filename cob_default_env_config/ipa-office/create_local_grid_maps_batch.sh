...
./create_local_grid_maps_manual.sh 651 417 321 78

# outer stairwell- east
./create_local_grid_maps_manual.sh 964 493 57 298

# outer stairwell- south
./create_local_grid_maps_manual.sh 645 777 330 83

# outer stairwell- west
./create_local_grid_maps_manual.sh 603 468 71 325
